...
print(validation_data_frame_knn$results[order(-validation_data_frame_knn$results$Accuracy), ][1:5, ])
```
...
plot(grid$x, grid$y, col = boundary_colors[predicted_labels_knn], pch = ".", cex = 3.5, xlab = "x", ylab = "y")
points(data2$x, data2$y, col = point_colors[data2$class], pch = 19)
```
...
# Plot with base R
plot(mnist_27$train$x_1, mnist_27$train$x_2, col = point_colors[mnist_27$train$y],
...
plot(grid$x_1, grid$x_2, col = boundary_colors[predicted_labels_rbf_mnist],
     pch = ".", cex = 3.5,
     xlab = "Proportion of dark pixels in the upper-left quadrant", ylab = "Proportion of dark pixels in the lower-right quadrant")
points(mnist_27$train$x_1, mnist_27$train$x_2,
       col = point_colors[mnist_27$train$y], pch = 19)
```
...
predicted_labels_knn_mnist <- predict(knn_model_mnist,
                                      ...
                                      type = "class")
confusionMatrix(predicted_labels_knn_mnist, training_matrix$class) |> simpler_cm()
...
# Create a confusion matrix to evaluate the KNN model
confusionMatrix(predicted_labels_knn_mnist_test, mnist_27$test$y) |> simpler_cm()
```
