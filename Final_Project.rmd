...
X = np.vstack(
    [
        template + np.array([0,0]), template + np.array([1,0]), template + np.array([2,0]),
        template + np.array([0,1]), template + np.array([1,1]), template + np.array([2,1]),
        template + np.array([0,2]), template + np.array([1,2]), template + np.array([2,2])
    ]
)
