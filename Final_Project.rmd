...
Consider the following non-linearly separable data:
...
In this case, the best SVM can do is classify everything as the majority class (purple).
...
Applying this kernel on our data clearly results in a better classification, although not quite perfect:
